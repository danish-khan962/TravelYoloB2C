            ...
            <div className='w-full max-w-[1440px] mx-auto px-4 md:px-6 lg:px-8 flex flex-col-reverse lg:flex-row justify-between gap-y-[35px]'>
                ...
                <div className='flex flex-col'>
                    ...
                    <div className='hidden sm:flex flex-row gap-x-4 mt-[24px]'>
                        ...
                        <span>
                            <Link href={"https://www.instagram.com/travelyollo/"} target="_blank" rel="noopener noreferrer">
                                <Image src={"/images/instagram_icon.png"} alt={"instagram"} height={36} width={36} className='h-[36px] w-[36px]' />
                            </Link>
                        </span>
                        <span>
                            <Link href={"https://www.facebook.com/profile.php?id=61573601551252"} target="_blank" rel="noopener noreferrer">
                                <Image src={"/images/facebook_icon.png"} alt={"facebook"} height={36} width={36} className='h-[36px] w-[36px]' />
                            </Link>
                        </span>
                    </div>
                </div>
                ...
                <div className='max-w-[1440px] mx-auto px-4 md:px-6 lg:px-8'>
                    ...
                    <div className='flex flex-row justify-between items-center py-[22px]'>
                        ...
                        <p className='text-[14px] text-[#C9C9C9] font-host-grotesk font-light'>
                            <a
                                href="https://drive.google.com/file/d/1cyi4iDTv7S4rSxP7fkvhqs06wpIYPrz0/view"
                                target="_blank"
                                rel="noopener noreferrer"
                            ...
                            {"  |  "}
                            <a
                                href="https://drive.google.com/file/d/1YUM_pXnm0xCbMq1_W2pCnW4A-9wbG2oh/view"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="hover:underline"
                            >
