      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12">
        <div className="flex flex-col gap-12 sm:gap-16 lg:gap-20 relative">
          <div className="text-left">
            ...
            <p
              className="text-[14px] sm:text-[16px] lg:text-[18px] font-host-grotesk font-light leading-relaxed mt-4 max-w-[400px] w-full pr-24 sm:pr-20"
              style={{ color: '#312E29' }}
            >
          ...
          <div className="relative mt-6">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-y-1/2 -translate-x-60 sm:-translate-x-36 lg:-translate-x-20 z-0 pointer-events-none">
